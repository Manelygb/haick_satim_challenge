...
function Assistant({ socket }) {
  const [messages, setMessages] = useState([
    {
      type: 'assistant',
      content: 'Hello! I\'m your SATIM AI Assistant. I can help you with payments, withdrawals, balance inquiries, and more. How can I assist you today?',
